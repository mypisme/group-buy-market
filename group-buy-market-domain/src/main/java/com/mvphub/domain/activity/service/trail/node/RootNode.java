...
@Service
@Slf4j
public class RootNode<MarketProductEntity, DynamicContext, TrailBalanceEntity> extends abstractGroupBuyMarketSupport<MarketProductEntity, DynamicContext, TrailBalanceEntity> {
    private SwitchNode<MarketProductEntity, DynamicContext, TrailBalanceEntity> switchNode;
