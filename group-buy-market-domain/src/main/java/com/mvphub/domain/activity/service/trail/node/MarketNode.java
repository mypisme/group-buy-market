...
@Service
@Slf4j
public class MarketNode<MarketProductEntity, DynamicContext, TrailBalanceEntity> extends abstractGroupBuyMarketSupport<MarketProductEntity, DynamicContext, TrailBalanceEntity> {
